...
public class Jeapordy implements ActionListener {
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		if (buttonPressed == firstButton) {
			askQuestion("What movie were the guys going off of when they made Murr dress up as a statue of liberty"
					+ " and made him swim back up on a blowup alligator?", "Taken", 1000);
			firstButton.setText("");
		}
		...
		// Or if the buttonPressed was the secondButton
			...
			askQuestion("What did Sal have to bury that was never ever going to be buried", "A little girl", 150);
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		if (q != null && q.equalsIgnoreCase(correctAnswer)) {
			score += prizeMoney;
			updateScore();
