...
public class SimonSays extends KeyAdapter {
	...
	private void makeAlbum() {
		...
		images.put(new Integer(KeyEvent.VK_LEFT), "images-1.png");
		images.put(new Integer(KeyEvent.VK_UP), "images.png");
		images.put(new Integer(KeyEvent.VK_RIGHT), "images-1.jpg");
		// 3. Tell the user to "Press the matching key when 'Simon says'
		// otherwise press a different key"
		JOptionPane.showMessageDialog(null, "Press the matching key when Simon says so.  If not press any another one");
...
// 18. if the keyCode doesn't match the imageIndex and "Simon didn't
	...
	private void showImage() {
		...
		// frame
		arrow.add(getNextRandomImage());
		// 8. set the size of the frame
		arrow.setSize(500, 500);
		// 9. add a key listener to the frame
		arrow.addKeyListener(this);
